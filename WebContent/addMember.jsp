...
<form class="col-sm-6 form-horizontal" action="member" method='get' onsubmit="return checkAll();" role="form" style="margin-top:3%;border-radius: 4px;border: 2px solid green;background-color: rgba(87,168,29,0.3);">
    ...
    <div class="form-group">
	<label for="userName" class="col-sm-3 control-label" style="margin-top:2px;color:green;">地址</label>
    	<div class="col-sm-8">
      		<input type="text" name="address" class="form-control" id="sname" placeholder="請填寫地址">
    	</div>    
	</div>
    <div class="form-group">
