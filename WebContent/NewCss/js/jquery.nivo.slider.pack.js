...
(function($) {
    ...
    var NivoSlider = function(element, options){
        ...
        //Useful variables. Play carefullynivoSlider
            ...
            for(var i = 0; i < kids.length; i++){
                if(settings.controlNavThumbs){
                    ...
                    if (settings.controlNavThumbsFromRel) {
                        nivoControl.append('<img src="'+ child.attr('rel') + '" alt="" /></a>');
                    } else {
                        nivoControl.append('<img src="'+ child.attr('src').replace(settings.controlNavThumbsSearch, settings.controlNavThumbsReplace) +'" alt="" /></a>');
                    }
                } else {
