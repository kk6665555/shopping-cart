					...
					<div class="col-sm-12 col-md-offset-3">
						...
						<div id="product"  class="flow_steps clearfix">
								  <ul id="test" class="clearfix steps">
									    <li id="one" class=""><a id="size" href="test.jsp">購物清單</a></li>
									    <li id="two" class="current_prev"><a id="size" data-toggle="tab" href="#">完成</a></li>
									    <li id="three" class="active done first current last"><a id="size" href="test1.jsp">確認</a></li>  
								  </ul>
						</div>
