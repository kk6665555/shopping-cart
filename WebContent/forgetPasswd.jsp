...
<form class="col-sm-4 form-horizontal" action="emailGetPasswd"  method='post' role="form" style="margin-top:3%;border-radius: 4px;border: 2px solid green;background-color: rgba(87,168,29,0.3);">
	...
	<div class="form-group" style="margin-top:2px">
	<label for="passwd" class="col-sm-3 control-label" style="color:green;">信箱</label>
    	<div class="col-sm-6">
      		<input type="text" name="email"  class="form-control" placeholder="請輸入註冊的信箱" onblur="checkPass()">
    	</div>
